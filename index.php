        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-6 col-xs-4">
               <ul class="top-navigation hidden-sm hidden-xs">
                <li><a href="#"><font style="color: red;font-size: 25px;">EST. SINCE 1952</font></a></li>
               </ul>
...
<li><a href="brands.php">Brands</a>
    <!--<ul class="dropdown">
                ...
                <li><a href="#"></a></li>
                <li><a href="#"></a></li>
                <li><a href="#"><b style="font-weight: bold;">Call Us : +91 22 27898888</b></a></li>
  ...
  <div class="hero-slider flexslider clearfix" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes">
    <ul class="slides">
      ...
      <li class="parallax" style="background-image:url(images/2.jpg);"></li>
      <li class="parallax" style="background-image:url(images/3.jpg);"></li>
      <li class="parallax" style="background-image:url(images/4.jpg);"></li>
      <li class="parallax" style="background-image:url(images/5.jpg);"></li>
    </ul>
  </div>
  <!-- End Hero Slider --> 
  <!-- Start Notice Bar -->
      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="featured-blocks clearfix">
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/1.jpg" alt="staff"> <strong>MTB CYCLE</strong> <span class="more">view all</span> </a> </div>
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/2.jpg" alt="staff"> <strong>BMX BIKES</strong> <span class="more">view all</span> </a> </div>
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/3.jpg" alt="staff"> <strong>HYBRID BIKES</strong> <span class="more">view all</span> </a> </div>
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/4.jpg" alt="staff"> <strong>ROAD BIKES</strong> <span class="more">view all</span> </a> </div>
          </div>
          <div class="featured-blocks clearfix">
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/5.jpg" alt="staff" style="height:147px;"> <strong>LADIES CYCLES</strong> <span class="more">view all</span> </a> </div>
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/6.jpg" alt="staff"  style="height:147px;"> <strong>BIKES FOR KIDS</strong> <span class="more">view all</span> </a> </div>
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/7.jpg" alt="staff" style="height:147px;"> <strong>WORKOUT MACHINES</strong> <span class="more">view all</span> </a> </div>
            <div class="col-md-3 col-sm-3 featured-block"> <a href="#" class="img-thumbnail"> <img src="favorate/8.jpg" alt="staff" style="height:147px;width:250px;"> <strong>FOLDABLE BIKES</strong> <span class="more">view all</span> </a> </div>
          </div>
          <!-- End Featured Blocks --> 
        </div>
     <!--   <div class="row">
